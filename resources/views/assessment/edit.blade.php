        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 ">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="@php echo '/assessment/' . Auth::user()->username . '/edit' @endphp">
                        @method('PATCH')
                        @csrf
                        @foreach ($getAssessment as $assessment )
                            ...
                            <div class="mt-4" x-data="{ show: false }">
                                ...
                                Answer: {{ $assessment->as_ws_timeframe }} 
                                {{ $assessment->as_ws_timeframe_text }}
                    ...
                    <div class="mt-4">
                        ...
                        <table class="mt-4">
                            ...
                            <tr>
                                <td>
                                    <form  method="POST" action="@php echo '/assessment/picture/' .  $image->imageName @endphp">
                                        @csrf
                                        @method('delete')
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <form  method="POST" action="@php echo '/assessment/video/' . $video->videoName @endphp">
                                        @csrf
                                        @method('delete')
                                        <x-button type="submit" class="mt-4"> 
                                            delete &times;
